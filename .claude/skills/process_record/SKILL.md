...
**Commit:** [`5e48816`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit4-jnheinrich451-eng/commit/5e48816)
...
- **Always the absolute GitHub URL**, exactly as written above:
  `[`<7-char sha>`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit4-jnheinrich451-eng/commit/<7-char sha>)`.
...
Carried forward from `comp4020-ass1-jnheinrich451-eng`, where this skill was
written, with the citation URL repointed at this repo. `.gitignore` excludes
`.claude/`, so this file is tracked only because it was added with `git add -f`;
it holds no secrets, and it is part of the harness a marker reads.
